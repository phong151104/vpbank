# -*- coding: utf-8 -*-
"""Generator: builds training_dedup.ipynb (tuning + chọn K=15-30, KHÔNG ensemble)."""
...
# ----------------------------------------------------------------------------
md('''# VPINS — AIA Challenge: Training — CLONE thử nghiệm (ranking ĐÃ dedupe, K=10–30)
...
code('''# TRD01 — meanK ± SE theo mô hình
...
# ----------------------------------------------------------------------------
md('''## 5. Mô hình cuối → `submission_800_dedup.txt`
...
with open("training_dedup.ipynb", "w", encoding="utf-8") as f:
    nbf.write(nb, f)
print("WROTE training_dedup.ipynb with", len(cells), "cells")
