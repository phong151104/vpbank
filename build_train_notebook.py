...
# ----------------------------------------------------------------------------
md('''## 5. Mô hình cuối → `submission_800_final.txt`
...
top800, full = make_submission(test_score, test_ids, k=800,
                               out_path="submission_800_final.txt", full_csv="outputs/test_scores_final.csv")
ok, ids = verify_submission("submission_800_final.txt")
...
print(res.round(4).to_string(index=False))
print("\\nFile: submission_800_final.txt | outputs/test_scores_final.csv | figures/TR01..TR04")
